...
packages = [
            'tuxeatpi_hotword_kittai',
            'tuxeatpi_hotword_kittai.libs',
            ]

setup(
    name='tuxeatpi_hotword_kittai',
    version='0.0.1',
    packages=packages,
    ...
    package_data={'': ['LICENSE.txt'], 'tuxeatpi_hotword_kittai': ['libs/resources/*', 'libs/*']},
    package_dir={'tuxeatpi_hotword_kittai': 'tuxeatpi_hotword_kittai'},
    entry_points={
        'console_scripts': [
            'tep-hotword-kittai = tuxeatpi_hotword_kittai.common:cli'
        ]
    },
